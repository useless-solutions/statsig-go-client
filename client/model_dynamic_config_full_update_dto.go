...
// checks if the DynamicConfigFullUpdateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicConfigFullUpdateDto{}

// DynamicConfigFullUpdateDto struct for DynamicConfigFullUpdateDto
...
type _DynamicConfigFullUpdateDto DynamicConfigFullUpdateDto
...
func NewDynamicConfigFullUpdateDto(isEnabled bool, description string, rules []DynamicConfigDtoRulesInner) *DynamicConfigFullUpdateDto {
	this := DynamicConfigFullUpdateDto{}
...
func (o DynamicConfigFullUpdateDto) MarshalJSON() ([]byte, error) {
...
func (o DynamicConfigFullUpdateDto) ToMap() (map[string]interface{}, error) {
...
func (o *DynamicConfigFullUpdateDto) UnmarshalJSON(data []byte) (err error) {
	...
	varDynamicConfigFullUpdateDto := _DynamicConfigFullUpdateDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDynamicConfigFullUpdateDto)

	if err != nil {
		return err
	}

	*o = DynamicConfigFullUpdateDto(varDynamicConfigFullUpdateDto)

	return err
}

type NullableDynamicConfigFullUpdateDto struct {
	value *DynamicConfigFullUpdateDto
	isSet bool
}

func (v NullableDynamicConfigFullUpdateDto) Get() *DynamicConfigFullUpdateDto {
	return v.value
}

func (v *NullableDynamicConfigFullUpdateDto) Set(val *DynamicConfigFullUpdateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableDynamicConfigFullUpdateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableDynamicConfigFullUpdateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDynamicConfigFullUpdateDto(val *DynamicConfigFullUpdateDto) *NullableDynamicConfigFullUpdateDto {
	return &NullableDynamicConfigFullUpdateDto{value: val, isSet: true}
}

func (v NullableDynamicConfigFullUpdateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDynamicConfigFullUpdateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
