...
// checks if the MultiRuleUpdateDtoRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiRuleUpdateDtoRulesInner{}

// MultiRuleUpdateDtoRulesInner struct for MultiRuleUpdateDtoRulesInner
type MultiRuleUpdateDtoRulesInner struct {
...
func NewMultiRuleUpdateDtoRulesInner() *MultiRuleUpdateDtoRulesInner {
	this := MultiRuleUpdateDtoRulesInner{}
	return &this
}
...
func (o MultiRuleUpdateDtoRulesInner) MarshalJSON() ([]byte, error) {
...
func (o MultiRuleUpdateDtoRulesInner) ToMap() (map[string]interface{}, error) {
...
type NullableMultiRuleUpdateDtoRulesInner struct {
	value *MultiRuleUpdateDtoRulesInner
	isSet bool
}

func (v NullableMultiRuleUpdateDtoRulesInner) Get() *MultiRuleUpdateDtoRulesInner {
	return v.value
}

func (v *NullableMultiRuleUpdateDtoRulesInner) Set(val *MultiRuleUpdateDtoRulesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiRuleUpdateDtoRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiRuleUpdateDtoRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiRuleUpdateDtoRulesInner(val *MultiRuleUpdateDtoRulesInner) *NullableMultiRuleUpdateDtoRulesInner {
	return &NullableMultiRuleUpdateDtoRulesInner{value: val, isSet: true}
}

func (v NullableMultiRuleUpdateDtoRulesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiRuleUpdateDtoRulesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
